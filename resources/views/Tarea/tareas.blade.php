...
@section('contenido')
    ...
    <p>
        <a href="{{ route('tareas.create') }}"><input type="button" value="Añadir tarea" class="btn btn-primary "
                id="btAñadirTarea"></a>
    </p>
            ...
            @foreach ($tareas as $tarea)
                <tr id={{ $tarea->tarea_id }}>
                    ...
                    <td>
                        ...
                        {{-- Borrar --}}
                        <a href="{{ route('tareas.show', $tarea->tarea_id) }}" class="icons">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
