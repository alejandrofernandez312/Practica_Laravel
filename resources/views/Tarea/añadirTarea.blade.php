...
@section('contenido')
    ...
    <p>
        <a href="{{ route('tareas.index') }}"><input type="button" value="Volver" class="btn btn-primary"
                id="btAñadirTarea"></a>
    </p>
                ...
                <p>Empleado:
                    <br><select name="empleado" class="form-select" id="empleado">
                        @foreach ($empleados as $empleado)
                            <option value="{{ $empleado->empleado_id }}">{{ $empleado->nombre }} ({{ $empleado->email }})
                            </option>
                        @endforeach
                    </select>
                </p>
