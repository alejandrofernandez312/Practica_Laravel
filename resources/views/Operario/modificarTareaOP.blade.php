    ...
    <form action="{{ route('operario.update', $tarea->tarea_id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="container row">
            <div class="col-6">
                <p>Nombre:
                    <br><input type="text" name="nombre" class="form-control" id="nombre"
                        value="{{ old('nombre', $tarea->nombre) }}" readonly>
                </p>
                ...
                <p>Descripción:
                    <br><input type="text" name="descripcion" class="form-control" id="descripcion"
                        value="{{ $tarea->descripcion }}" readonly>
                </p>
            ...
            <div class="col-6">
                ...
                <p>Cliente:
                    <br><input type="text" name="cliente" class="form-control" id="cliente"
                        value="{{ $tarea->cliente->nombre }} ({{ $tarea->cliente->email }})" readonly>
                </p>
                <p>Empleado:
                    <br><input type="text" name="empleado" class="form-control" id="empleado"
                        value="{{ $tarea->empleado->nombre }} ({{ $tarea->empleado->email }})" readonly>
                </p>
            </div>
        </div>
    </form>
