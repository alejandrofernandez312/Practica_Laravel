        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            @if (auth()->user()->esAdministrador())
                ...
                <a href="{{ route('tareas.index')}}" class="d-flex me-4 align-items-center mb-lg-0 text-white text-decoration-none h4">
                    SiempreColgados
                </a>

                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="{{ route('tareasNoAsignadas.index')}}" class="nav-link px-2 text-white">Tareas sin asignar</a></li>
                    ...
                    <li><a href="{{ route('empleadosJS.index')}}" class="nav-link px-2 text-white">Empleados JS</a></li>
                </ul>

            @else
                <a href="{{ route('operario.index')}}" class="d-flex me-4 align-items-center mb-lg-0 text-white text-decoration-none h4">
                    SiempreColgados
                </a>
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
