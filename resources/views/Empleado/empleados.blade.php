...
@section('contenido')
    ...
    <p>
        <a href="{{ route('empleados.create') }}"><input type="button" value="Añadir empleado" class="btn btn-primary "
                id="btAñadirTarea"></a>
    </p>
            ...
            @foreach ($empleados as $empleado)
                <tr id={{ $empleado->empleado_id }}>
                    ...
                    <td>
                        ...
                        {{-- Borrar --}}
                        <a href="{{ route('empleados.show', $empleado->empleado_id) }}" class="icons">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
