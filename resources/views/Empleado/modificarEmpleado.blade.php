    ...
    <form action="{{ route('empleados.update', $empleado->empleado_id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="container row">
            <div class="col-6">
                ...
                @enderror
                <p>DNI:
                    <br><input type="text" name="dni" class="form-control" id="dni"
            ...
            <div class="col-6">
                ...
                <p>Fecha alta:
                    <br><input type="text" name="f_alta" class="form-control" id="f_alta"
                        value="{{ date('d-m-Y', strtotime($empleado->f_alta)) }}" readonly>
                </p>
                @error('f_alta')
                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
