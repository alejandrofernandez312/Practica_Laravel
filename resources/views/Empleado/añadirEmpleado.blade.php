    ...
    <form action="{{ route('empleados.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="container row">
            <div class="col-6">
                ...
                @enderror
                <p>Password:
                    <br><input type="text" name="password" class="form-control" id="password" value="{{ old('password') }}">
                </p>
                @error('password')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
            ...
            <div class="col-6">
                ...
                <p>Fecha alta:
                    <br><input type="text" name="f_alta" class="form-control" id="f_alta" value="<?= Date('d-m-Y') ?>" readonly>
                </p>
                @error('f_alta')
                            <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                @enderror
